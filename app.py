...
with st.sidebar:
    ...
    with tab_instructions:
        ...
        st.markdown("1. Go to the **Setup** tab and enter your **OpenAI API Key**.")
        st.markdown("2. Enter your **Tavily API Key** if you wish to enable real-time web searching capabilities.")
        st.markdown("3. Select a persona mode (e.g., **Coding Mode** for technical assistance).")
        ...
        st.markdown("* **File Analysis:** Upload source files (`.py`, `.json`, `.csv`) or images in the **Attachments** tab before submitting your prompt.")
